...
Cada ficha gera automaticamente um cartão contendo:
...
- 👤 Usuário do Wattpad
- 📅 Data de nascimento
- 💬 Participação em feedbacks
- 🧾 ID exclusivo
- 📛 Selo oficial

O cartão pode ser baixado e compartilhado.

### ⚠️ Observações

Atualmente, as fichas são armazenadas externamente (Notion).
Este sistema tem como foco a padronização e geração das fichas, não o armazenamento definitivo.

## 👥 Público-Alvo

- ✍️ Escritores iniciantes e experientes
- 🛠️ Administradores do projeto
- 🌹 Membros da comunidade Dark Roses

## 🌹 Filosofia do Projeto

"Tudo que fazemos, fazemos da melhor forma para quem faz parte."
